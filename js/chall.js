const CHALLENGES = [
	...
	},
	{
		...
		reward(){
			return "Boost ascension points based on best rarity in this challenge. Currently: "+formatMult(hasUpgrade('se',9)?player.chall[10].add(1).pow(player.upgrade.se[9].log10().add(1)):player.chall[10].add(1).log10().add(1));
		},
		unl(){
